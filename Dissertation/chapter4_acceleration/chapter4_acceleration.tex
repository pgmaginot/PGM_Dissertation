...
We will estimate $\rho$ as a function of $\widebar{\Sigma_t \Delta x}$, the average optical thickness of each mesh cell.
For values of $\widebar{\Sigma_t \Delta x} > 2$, we will use 10 mesh cells, and adjust $\Sigma_{t,0}$ to achieve the desired optical thickness.
For values of $\widebar{\Sigma_t \Delta x} < 2$, we will hold $\Sigma_{t,0}$ constant, and increase the number of mesh cells.
...
\benum
\Sigma_{t,0} = \frac{5}{  \exp[5] - 1 \right }\pep
\eenum
For values of $\widebar{\Sigma_t \Delta x} > 2$,
\beanum
10 \widebar{\Sigma_t \Delta x} &=& 4\Sigma_{t,0} \left( \exp[5] - 1 \right) \\
\Sigma_{t,0} = \frac{5\widebar{\Sigma_t \Delta x}}{2 \left( \exp[5] - 1 \right) } \pep
\eeanum
\end{subequations}
