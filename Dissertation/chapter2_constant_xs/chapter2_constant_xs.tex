...
In \secref{sec:introduction}, we briefly mentioned that through manipulation, the thermal radiative transfer equations can be put into a form equivalent to the 
neutron transport equation with pseudo- scattering, fission, and fixed sources.  
We will fully demonstrate the linearization process in \secref{sec:chapter6_grey_radtran}, but for now we 
