...
In \chapref{sec:introduction}, we briefly mentioned that through manipulation, the thermal radiative transfer equations can be put into a form equivalent to the 
...
in time-dependent thermal radiative transfer simulations, in particular Marshak wave type problems \cite{ober_shadid}.  This chapter draws primarily from
...
Differences between $\psi{out,d,T}$ and the corresponding numerical analogs are given in \tbl{tbl:taylor_out_part1} for Exact DFEM and TL  and 
