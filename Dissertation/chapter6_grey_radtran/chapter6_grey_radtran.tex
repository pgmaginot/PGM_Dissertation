...
\benum
\R{\widetilde{\Sigma}_s,jk} = \frac{\Delta x}{2}\int_{-1}^1{  \B{j}(s) \B{k}(s)~ds   \left( \sigma_s +  \frac{ 4\pi a_{ii} \sigma_a D_*}{C_v + 4\pi a_{ii} \Delta t  \sigma_a D_*} \sigma_a \right)  } \pep
\label{eq:to_split}
\eenum
...
\benum
\frac{\Delta x}{2}\int_{-1}^1{ \B{j}(s) \B{k} \left(  \frac{ 4\pi a_{ii} \sigma_a D_*}{C_v + 4\pi a_{ii} \Delta t  \sigma_a D_*} \sigma_a \right) ds} = \overline{\overline{\nu}}_i \R{\sigma_a} \pep
\eenum
...
\subsubsection{Linear Space - Linear Time  }
...
Figure \ref{fig:mms1_linear_phi}, \fig{fig:mms1_quadratic_phi}, \fig{fig:mms1_cubic_phi}, and \fig{fig:mms1_quartic_phi} respectively give the convergence of linear, quadratic, cubic, and quartic DFEM as a function of number of cells for the SL Lobatto, SL Gauss, and TL schemes for $E_{\phi}$.
Analogous data for $E_{T}$ is given in \figs{fig:mms1_linear_temp}{fig:mms1_quartic_temp}.
\begin{figure}[!ht]
\centering
...
\subsubsection{Trigonometric Space - Linear Time - With Temperature Dependent Material Properties}
