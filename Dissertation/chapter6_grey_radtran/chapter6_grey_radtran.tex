...
For all significant values of $N_{dir}$, the need to store $\vec{I}_n$ and $\vec{k}_I$ will dominate the memory footprint of our implementation, and a reasonable upper bound on memory usage is $(1+N_{stage}) \times N_{dir} \times N_{cell} \times N_P$.
