...
For example, if we were to use the spatailly analytic Planck linearization of \eqt{eq:analytic_pseudo_i} to define a macroscopic cross section for MIP DSA,
\benum
\widetilde{\Sigma_t} = \sigma_{\tau,i} \pec
\eenum
would $\R{\widetilde{\Sigma}_{t,i}}$ be equivalent to $\overline{\overline{\mathbf{R}}}_{\sigma_{\tau,i}}$ of \eqt{eq:step_i_defs}?
