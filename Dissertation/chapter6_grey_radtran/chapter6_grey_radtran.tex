...
In \fig{fig:low_tol_slxs_gauss_temp} and \fig{fig:low_tol_slxs_lobatto_phi}, we give the results for $E_{T}$ convergence for the SLXS Gauss scheme and $E_{\phi}$ covnergence for the SLXS Lobatto scheme for MMS2, but use $\epsilon_T=10^{-8}$ and $\epsilon_{\phi} = 10^{-10}$.
\begin{figure}[!hbp]
\centering
\includegraphics[width=10cm,trim=0.25in  0.25in 0.75in 0.75in,clip=true]{chapter6_grey_radtran/Dissertation_Data/MMS3_Low_Tol_SLXS_Gauss_temp_L2.pdf}
...
\begin{figure}[!htp]
\centering
\includegraphics[width=10cm,trim=0.25in  0.25in 0.75in 0.75in,clip=true]{chapter6_grey_radtran/Dissertation_Data/MMS3_Low_Tol_SLXS_Lobatto_phi_L2.pdf}
...
Typically these are not observed in thermal radiative transfer simulations, because as the material heats up, the magnitude of photon re-emission sources quickly becomes comparable to the rapid attenuation of the incident photon energy.
...
If the observed kinks are time ray effects, they will be worse at earlier times and less pronounced at later times, due to the attenuation of the incident intensity over a greater distance (as the wave front advances) and increased material temperature from photon heating.
\begin{figure}[!htp]
\centering
