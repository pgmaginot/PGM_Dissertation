...
h=legend('P1','P2','P3','P4','$O(\Delta x^2)$','$O(\Delta x^3)$','Location','SouthWest');
...
h=legend('P3','P4','$O(\Delta x^2)$','$O(\Delta x^3)$','$O(\Delta x^4)$','$O(\Delta x^5)$','Location','SouthEast');
...
h=legend('P1','P2','P3','P4','$O(\Delta x^2)$','Location','SouthWest');
set(h,'Interpreter','latex','Fontsize',14);
...
h=legend('P1','P2','P3','P4','$O(\Delta x^4)$','$O(\Delta x^6)$','Location','NorthWest');
set(h,'Interpreter','latex','Fontsize',14);
