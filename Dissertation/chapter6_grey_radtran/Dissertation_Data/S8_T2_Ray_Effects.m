...
cell_base = {   sprintf('Marshak_Results/MW_S8_Cv1_T2_SigA_1') ...
                };

data_base = {   sprintf('Marshak_Results/MW_S8_Cv1_T2_SigA_1') ...
                };
...
axis([0 1 -0.05 1.5]) 
SavePretty(gcf,'S8_T2_Temperature_Cv1_SigA1');

% Radiation
figure(2)
set(gca, 'FontName','Times','FontSize',18)
axis([0 1 -0.05 2.5])
text(0.38 , 1.45 , '$\mu=0.1834$' , 'Interpreter','latex','FontSize',18 );
set(gcf,'OuterPosition',[-7 33 1936 1056],'PaperPosition',[0.2500  2.5000 8.0000 6.0000],'PaperSize',[8.5 11] , 'Position', [1 41 1920  964])
SavePretty(gcf,'S8_T2_Radiation_Cv1_SigA1');
...
set(gcf,'OuterPosition',[-7 33 1936 1056],'PaperPosition',[0.2500  2.5000 8.0000 6.0000],'PaperSize',[8.5 11] , 'Position', [1 41 1920  964])
SavePretty(gcf,'S8_T2_Intensity')