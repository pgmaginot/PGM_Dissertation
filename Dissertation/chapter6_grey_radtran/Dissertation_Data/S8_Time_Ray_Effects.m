...
cell_base = {   sprintf('Marshak_Results/MW_S8_Cv1_T01_SigA_1') ...
                sprintf('Marshak_Results/MW_S8_Cv1_T05_SigA_1') ...
                sprintf('Marshak_Results/MW_S8_Cv1_T1_SigA_1') ...
                sprintf('Marshak_Results/MW_S8_Cv1_T2_SigA_1') ...
                };
...
temperature_file = sprintf('S8_Time_Ray_Effects_Temperature_Cv1_SigA1');
rad_file = sprintf('S8_Time_Ray_Effects_Radiation_Cv1_SigA1');
